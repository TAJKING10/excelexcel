...
export const monthlyPayslipService = {
  async getByPeriod(
    ...
    if (error) {
      ...
      if (error.code === 'PGRST116') {
        ...
        return {
          ...
          customExpense1Label: mostRecent.custom_expense_1_label || '',
          customExpense1Amount: mostRecent.custom_expense_1_amount || 0,
          customExpense2Label: mostRecent.custom_expense_2_label || '',
    ...
    return {
      ...
      customExpense1Label: data.custom_expense_1_label || '',
      customExpense1Amount: data.custom_expense_1_amount ? parseFloat(data.custom_expense_1_amount) : 0,
      customExpense2Label: data.custom_expense_2_label || '',
  ...
  async save(payslipData: MonthlyPayslipData): Promise<MonthlyPayslipData> {
    ...
    const dbData: any = {
      ...
      custom_expense_1_label: payslipData.customExpense1Label || '',
      custom_expense_1_amount: payslipData.customExpense1Amount || 0,
      custom_expense_2_label: payslipData.customExpense2Label || '',
